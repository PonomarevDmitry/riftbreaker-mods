...
function mech:OnDestroyRequest( evt )
	local playerPos = EntityService:GetPosition(self.entity) -- MOD
	LampService:ReportMechDestroy()
	EntityService:SpawnEntity("items/consumables/sentry_gun_extreme", playerPos.x, playerPos.y, playerPos.z, "player" )  -- MOD
end
