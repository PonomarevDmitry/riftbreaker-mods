...
function bomogan_emp:emp()
	local modAffectedBuildings = FindService:FindEntitiesByTypeInRadius( self.entity, "building", 6 )
	...
	local ent = EntityService:CreateEntity("effects/bomotimer")
	EntityService:CreateLifeTime( ent, 10, "normal")
